...
let DashPage = {
  ...
  page: {
    ...
    onAttach: function(worker) {
      ...
      const colors = {
        "Arts and Entertainment": "purple",
        "Autos and Vehicles": "black",
        "Beauty and Fitness": "red",
        "Books and Literature": "blue",
        "Business and Industry": "green",
        "Career and Education": "darkolivegreen",
        "Computer and Electronics": "brown",
        "Finance": "firebrick",
        "Food and Drink": "mediumvioletred",
        "Gambling": "navy",
        "Games": "teal",
        "Health": "tomato",
        "Home and Garden": "sienna",
        "Internet and Telecom": "seagreen",
        "Law and Government": "midnightblue",
        "News and Media": "indianred",
        "People and Society": "darkred",
        "Pets and Animals": "darkorange",
        "Recreation and Hobbies": "darkgreen",
        "Reference": "darkgoldenrod",
        "Science": "darkcyan",
        "Shopping": "darkslategray",
        "Sports": "darkorchid",
        "Travel": "royalblue",
      };

      let domains = TopDomains.getParticipatingDomains();
      let categories = {};
      Object.keys(domains).forEach(domain => {
        let cleanCat = domains[domain].category.split("/")[0].replace(/_/g, " ");
        categories[cleanCat] = true;
        domains[domain].category = cleanCat;
      });
      ...
      function filterSites(category) {
        ...
        Object.keys(domains).forEach(domain => {
          ...
          let site = domains[domain];
          if (category != null && site.category != category) {
            return;
          }

          top20.push({
            color: colors[site.category],
            new: Math.random() < 0.33,
            category: site.category,
            title: site.title.split(/\s*[-:|]/)[0],
